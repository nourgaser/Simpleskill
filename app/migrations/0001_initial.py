# Generated by Django 4.0.4 on 2022-04-21 13:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.category')),
                ('simpleskills', models.ManyToManyField(to='app.simpleskill')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='my_prerequisites', to='app.simpleskill'),
        ),
        migrations.AddField(
            model_name='prerequisite',
            name='to_simpleskill',
